...
const stepsByPlan: Record<Plan, Step[]> = {
  vitrina: [
    ...
    },
    {
      ...
      description: {
        es: "Una vez confirmada la reservación o contrato de arrendamiento, se aplica la comisión acordada. Esta se abona antes de la entrega de llaves o firma del contrato. Pagas solo cuando hay resultados confirmados.",
        en: "Once the booking or lease is confirmed, the agreed commission applies. It's paid before key handover or lease signing. You only pay when results are confirmed.",
        fr: "Une fois la réservation ou le bail confirmé, la commission convenue s'applique. Elle est versée avant la remise des clés ou la signature du bail. Vous ne payez que lorsque les résultats sont confirmés.",
        ru: "После подтверждения бронирования или договора аренды начисляется согласованная комиссия. Оплачивается до передачи ключей или подписания договора. Вы платите только при подтверждённом результате.",
        pt: "Uma vez confirmada a reserva ou o contrato de aluguel, a comissão acordada se aplica. É paga antes da entrega das chaves ou assinatura do contrato. Você só paga quando há resultados confirmados.",
        de: "Nach Bestätigung der Buchung oder des Mietvertrags gilt die vereinbarte Provision. Sie wird vor der Schlüsselübergabe oder Vertragsunterzeichnung gezahlt. Sie zahlen nur bei bestätigten Ergebnissen.",
      },
    },
  ],
  esencial: [
    {
      ...
      description: {
        es: `Escríbenos por WhatsApp o usa el formulario. Cuéntanos sobre tu propiedad. Aceptamos propiedades que cumplan con estándares mínimos de calidad, ubicación y potencial de renta. Te confirmamos en menos de 24 horas si es apta para el plan Esencial (ingreso potencial mínimo $${MIN_MONTHLY_INCOME_POTENTIAL_USD.esencial} USD/mes).`,
        en: `Message us on WhatsApp or use the form. Tell us about your property. We only accept properties that meet minimum standards for quality, location, and rental potential. We confirm within 24 hours whether it qualifies for the Essential plan (minimum income potential $${MIN_MONTHLY_INCOME_POTENTIAL_USD.esencial} USD/month).`,
        fr: `Écrivez-nous sur WhatsApp ou utilisez le formulaire. Parlez-nous de votre bien. Nous acceptons uniquement les biens qui respectent des standards minimums de qualité, d'emplacement et de potentiel locatif. Nous confirmons dans les 24 heures s'il est éligible au plan Essentiel (potentiel de revenu minimum $${MIN_MONTHLY_INCOME_POTENTIAL_USD.esencial} USD/mois).`,
        ru: `Напишите в WhatsApp или заполните форму. Расскажите об объекте. Мы принимаем только объекты, которые соответствуют минимальным стандартам качества, локации и арендного потенциала. Подтвердим в течение 24 часов, подходит ли он для базового плана (минимальный потенциальный доход $${MIN_MONTHLY_INCOME_POTENTIAL_USD.esencial} USD/мес).`,
        pt: `Escreva pelo WhatsApp ou use o formulário. Conte sobre seu imóvel. Aceitamos apenas propriedades que atendam a padrões mínimos de qualidade, localização e potencial de renda. Confirmamos em até 24 horas se ele se qualifica para o plano Essencial (potencial mínimo de $${MIN_MONTHLY_INCOME_POTENTIAL_USD.esencial} USD/mês).`,
        de: `Schreiben Sie uns auf WhatsApp oder nutzen Sie das Formular. Erzählen Sie von Ihrer Immobilie. Wir akzeptieren nur Immobilien, die Mindeststandards bei Qualität, Lage und Mietpotenzial erfüllen. Wir bestätigen innerhalb von 24 Stunden, ob sie für den Essential-Plan geeignet ist (Mindestpotenzial $${MIN_MONTHLY_INCOME_POTENTIAL_USD.esencial} USD/Monat).`,
      },
    },
    {
      title: {
  ...
  gestor: [
    {
      ...
      description: {
        es: `Escríbenos por WhatsApp o usa el formulario. Cuéntanos sobre tu propiedad. Aceptamos propiedades que cumplan con estándares mínimos de calidad, ubicación y potencial de renta. Respondemos en menos de 24 horas. Evaluamos si aplica el plan Gestor (potencial mínimo $${MIN_MONTHLY_INCOME_POTENTIAL_USD.fullManagement} USD/mes).`,
        en: `Message us on WhatsApp or use the form. Tell us about your property. We only accept properties that meet minimum standards for quality, location, and rental potential. We reply within 24 hours and assess whether it's a fit for Full Management (minimum $${MIN_MONTHLY_INCOME_POTENTIAL_USD.fullManagement} USD/month potential).`,
        fr: `Écrivez-nous sur WhatsApp ou utilisez le formulaire. Parlez-nous de votre bien. Nous acceptons uniquement les biens qui respectent des standards minimums de qualité, d'emplacement et de potentiel locatif. Nous répondons dans les 24 heures et évaluons si le plan Gestion complète correspond (potentiel minimum $${MIN_MONTHLY_INCOME_POTENTIAL_USD.fullManagement} USD/mois).`,
        ru: `Напишите в WhatsApp или заполните форму. Расскажите об объекте. Мы принимаем только объекты, которые соответствуют минимальным стандартам качества, локации и арендного потенциала. Ответим в течение 24 часов и оценим соответствие плану «Полное управление» (минимальный потенциал $${MIN_MONTHLY_INCOME_POTENTIAL_USD.fullManagement} USD/мес).`,
        pt: `Escreva pelo WhatsApp ou use o formulário. Conte sobre seu imóvel. Aceitamos apenas propriedades que atendam a padrões mínimos de qualidade, localização e potencial de renda. Respondemos em até 24 horas e avaliamos se ele se enquadra no Full Management (potencial mínimo $${MIN_MONTHLY_INCOME_POTENTIAL_USD.fullManagement} USD/mês).`,
        de: `Schreiben Sie uns auf WhatsApp oder nutzen Sie das Formular. Erzählen Sie von Ihrer Immobilie. Wir akzeptieren nur Immobilien, die Mindeststandards bei Qualität, Lage und Mietpotenzial erfüllen. Wir antworten innerhalb von 24 Stunden und prüfen, ob Full Management passt (Mindestpotenzial $${MIN_MONTHLY_INCOME_POTENTIAL_USD.fullManagement} USD/Monat).`,
      },
    },
    {
      title: {
    ...
    },
    {
      ...
      description: {
        es: "Nos encargamos de todo: la comunicación con huéspedes se maneja con un sistema de respuesta rápida, típicamente en minutos durante horas activas (con cobertura extendida para situaciones urgentes). Coordinamos check-in y check-out, gestionamos la limpieza después de cada estancia y manejamos el mantenimiento con tu presupuesto preaprobado. Nos encargamos de toda la operación diaria para que no tengas que involucrarte.",
        en: "We handle everything: guest communication is handled with a fast-response system, typically within minutes during active hours (extended coverage for urgent situations). We coordinate check-in and check-out, manage cleaning after every stay, and handle maintenance within your pre-approved budget. We run the day-to-day operation so you don't have to be involved.",
        fr: "Nous gérons tout : la communication avec les clients est gérée via un système de réponse rapide, généralement en quelques minutes pendant les heures actives (couverture étendue pour les situations urgentes). Nous coordonnons les arrivées et départs, gérons le nettoyage après chaque séjour et traitons la maintenance dans votre budget pré-approuvé. Nous gérons l'opération au quotidien pour que vous n'ayez pas à vous impliquer.",
        ru: "Берём всё на себя: общение с гостями ведётся через систему быстрого ответа — обычно в течение нескольких минут в активные часы (расширенное покрытие для срочных ситуаций). Мы координируем заезд и выезд, организуем уборку после каждого проживания и решаем вопросы обслуживания в рамках вашего предварительно согласованного бюджета. Мы ведём ежедневную операцию, чтобы вам не приходилось вовлекаться.",
        pt: "Cuidamos de tudo: a comunicação com hóspedes é feita com um sistema de resposta rápida, normalmente em minutos durante as horas ativas (cobertura estendida para situações urgentes). Coordenamos check-in e check-out, gerenciamos a limpeza após cada estadia e tratamos da manutenção dentro do seu orçamento pré-aprovado. Cuidamos da operação diária para que você não precise se envolver.",
        de: "Wir erledigen alles: Die Gästekommunikation erfolgt über ein Schnellantwort-System, typischerweise innerhalb von Minuten während aktiver Zeiten (erweiterte Abdeckung für dringende Situationen). Check-in und Check-out koordinieren wir, die Reinigung nach jedem Aufenthalt wird organisiert, und Wartung erfolgt im Rahmen Ihres vorab genehmigten Budgets. Wir übernehmen den täglichen Betrieb, damit Sie sich nicht einbringen müssen.",
      },
    },
    {
      title: {
      ...
      description: {
        es: "Cada mes recibes: tu parte de los ingresos de renta transferida dentro de los primeros 7 días hábiles de cada mes, y un reporte PDF con todas las reservaciones, gastos de limpieza y mantenimiento, nuestra comisión y tu ingreso neto. Todo transparente, sin letra pequeña. Nuestro objetivo es maximizar tu ocupación y tarifa promedio cada mes.",
        en: "Every month you receive: your share of rental income remitted within the first 7 business days of each month, and a PDF report with all bookings, cleaning and maintenance costs, our commission, and your net income. Fully transparent, no fine print. Our goal is to maximize your occupancy and average nightly rate each month.",
        fr: "Chaque mois, vous recevez : votre part des revenus locatifs versée dans les 7 premiers jours ouvrables de chaque mois, et un rapport PDF avec toutes les réservations, les frais de nettoyage et d'entretien, notre commission et votre revenu net. Entièrement transparent, sans petits caractères. Notre objectif est de maximiser votre taux d'occupation et votre tarif moyen chaque mois.",
        ru: "Каждый месяц вы получаете: вашу долю дохода от аренды, переводимую в течение первых 7 рабочих дней каждого месяца, и PDF-отчёт со всеми бронированиями, расходами на уборку и обслуживание, нашей комиссией и вашим чистым доходом. Полная прозрачность, без мелкого шрифта. Наша цель — каждый месяц максимально повышать вашу заполняемость и среднюю ставку.",
        pt: "Todo mês você recebe: sua parte da renda de aluguel transferida dentro dos primeiros 7 dias úteis de cada mês, e um relatório PDF com todas as reservas, custos de limpeza e manutenção, nossa comissão e sua renda líquida. Totalmente transparente, sem letras miúdas. Nosso objetivo é maximizar sua ocupação e sua tarifa média a cada mês.",
        de: "Jeden Monat erhalten Sie: Ihren Anteil der Mieteinnahmen innerhalb der ersten 7 Werktage jedes Monats, und einen PDF-Bericht mit allen Buchungen, Reinigungs- und Wartungskosten, unserer Provision und Ihrem Nettoeinkommen. Vollständig transparent, kein Kleingedrucktes. Unser Ziel ist es, Ihre Auslastung und Ihren Durchschnittspreis jeden Monat zu maximieren.",
      },
    },
    {
      title: {
